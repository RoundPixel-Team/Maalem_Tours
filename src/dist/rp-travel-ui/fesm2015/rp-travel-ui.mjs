...
class FlightCheckoutService {
        ...
        this.subscription.add(this.api.offlineServices(url).subscribe((res) => {
            this.allOfflineServices = [...res.map((s) => {
                    ...
                    if (s.recommended) {
                        ...
                        return Object.assign(Object.assign({}, s), { added: true, interaction: true });
                    }
                    else {
                        return Object.assign(Object.assign({}, s), { added: false, interaction: false });
                    }
                })];
            if (multiTypes) {
    ...
    validatePassengersForm() {
        ...
        for (var i = 0; i < this.usersArray.length; i++) {
            if (i == 0 && ((_a = this.usersArray.at(i).get('email')) === null || _a === void 0 ? void 0 : _a.errors) != null) {
                error = 'mainFormError';
    ...
    saveBooking(currentCurrency, type) {
        var _a, _b, _c, _d;
        this.loader = true;
        this.subscription.add(this.api.saveBooking((_a = this.selectedFlight) === null || _a === void 0 ? void 0 : _a.searchCriteria.searchId, (_b = this.selectedFlight) === null || _b === void 0 ? void 0 : _b.airItineraryDTO.sequenceNum, this.generateSaveBookingBodyParam(currentCurrency), (_c = this.selectedFlight) === null || _c === void 0 ? void 0 : _c.airItineraryDTO.pKey.toString(), (_d = this.selectedFlight) === null || _d === void 0 ? void 0 : _d.searchCriteria.language, type == 'premium' ? this.selectedOfflineServices : this.selectedOfflineServices.filter((s) => { var _a; return s != ((_a = this.recommendedOfflineService) === null || _a === void 0 ? void 0 : _a.serviceCode); }), this.home.pointOfSale.ip || "00.00.000.000", this.home.pointOfSale.country || 'kw')
            .subscribe((res) => {
    ...
    generateSaveBookingBodyParam(currentCurrency) {
        ...
        for (var i = 0; i < this.usersArray.length; i++) {
            ...
            if (((_a = this.usersArray.at(i).get('phoneNumber')) === null || _a === void 0 ? void 0 : _a.value) != '') {
                (_b = this.usersArray.at(i).get('countryCode')) === null || _b === void 0 ? void 0 : _b.setValue((_c = this.usersArray.at(i).get('phoneNumber')) === null || _c === void 0 ? void 0 : _c.value.dialCode.replace("+", ''));
                (_d = this.usersArray.at(i).get('phoneNumber')) === null || _d === void 0 ? void 0 : _d.setValue((_e = this.usersArray.at(i).get('phoneNumber')) === null || _e === void 0 ? void 0 : _e.value.number);
            }
            (_f = this.usersArray.at(i).get('countryOfResidence')) === null || _f === void 0 ? void 0 : _f.setValue(this.home.allCountries
                .filter(c => { var _a; return c.countryName == ((_a = this.usersArray.at(i).get('countryOfResidence')) === null || _a === void 0 ? void 0 : _a.value); })[0].pseudoCountryCode);
            (_g = this.usersArray.at(i).get('IssuedCountry')) === null || _g === void 0 ? void 0 : _g.setValue((_h = this.usersArray.at(i).get('countryOfResidence')) === null || _h === void 0 ? void 0 : _h.value);
            (_j = this.usersArray.at(i).get('nationality')) === null || _j === void 0 ? void 0 : _j.setValue((_k = this.usersArray.at(i).get('countryOfResidence')) === null || _k === void 0 ? void 0 : _k.value);
        }
        let object = {
            bookingEmail: (_l = this.usersArray.at(0).get('email')) === null || _l === void 0 ? void 0 : _l.value,
            DiscountCode: ((_m = this.copounCodeDetails) === null || _m === void 0 ? void 0 : _m.promotionDetails.discountCode) || '',
    ...
    calculateFareBreakupDisscount() {
        var _a;
        if ((_a = this.selectedFlight) === null || _a === void 0 ? void 0 : _a.airItineraryDTO.passengerFareBreakDownDTOs) {
    ...
    */
    calcEqfare(flightFaresDTO, type, farecalc) {
        var _a, _b;
        let fare = farecalc((_a = flightFaresDTO.filter((v) => v.passengerType === type)[0]) === null || _a === void 0 ? void 0 : _a.flightFaresDTOs);
        let quntity = (_b = flightFaresDTO.find((v) => v.passengerType === type)) === null || _b === void 0 ? void 0 : _b.passengerQuantity;
    ...
    */
    returnCorrectFare(fare) {
        var _a, _b, _c;
        if (fare) {
            let equivfare = (_a = fare.find(v => v.fareType.toLowerCase() === 'equivfare')) === null || _a === void 0 ? void 0 : _a.fareAmount;
            let totalFare = (_b = fare.find(v => v.fareType.toLowerCase() === 'totalfare')) === null || _b === void 0 ? void 0 : _b.fareAmount;
            let totalTax = (_c = fare.find(v => v.fareType.toLowerCase() === 'totaltax')) === null || _c === void 0 ? void 0 : _c.fareAmount;
    ...
    calculatePassengersFareBreakupValue() {
        ...
        let AdtFares = (_b = (_a = this.selectedFlight) === null || _a === void 0 ? void 0 : _a.airItineraryDTO.passengerFareBreakDownDTOs) === null || _b === void 0 ? void 0 : _b.find(v => v.passengerType === 'ADT');
        let ChildFare = (_d = (_c = this.selectedFlight) === null || _c === void 0 ? void 0 : _c.airItineraryDTO.passengerFareBreakDownDTOs) === null || _d === void 0 ? void 0 : _d.find(v => v.passengerType === 'CNN');
        let infFare = (_f = (_e = this.selectedFlight) === null || _e === void 0 ? void 0 : _e.airItineraryDTO.passengerFareBreakDownDTOs) === null || _f === void 0 ? void 0 : _f.find(v => v.passengerType === 'INF');
        this.fareBreackup = {
            ADT: {
...
class FlightResultService {
        ...
        if (SearchFlightModule) {
            ...
            this.subscription.add(this.api.searchFlight(myapi).subscribe((result) => {
                ...
                if (result.status == 'Valid') {
                    ...
                    (_a = this.filterForm.get("dpartingSlider")) === null || _a === void 0 ? void 0 : _a.setValue(this.findDepartingnMinMax(this.response.airItineraries));
                    (_b = this.filterForm.get("dpartingSlider")) === null || _b === void 0 ? void 0 : _b.updateValueAndValidity();
                    (_c = this.filterForm.get("durationSlider")) === null || _c === void 0 ? void 0 : _c.setValue(this.findDurationMinMax(this.response.airItineraries));
                    (_d = this.filterForm.get("durationSlider")) === null || _d === void 0 ? void 0 : _d.updateValueAndValidity();
                    // this.findDepartingnMinMax(this.response.airItineraries)
                    (_e = this.filterForm.get("arrivingSlider")) === null || _e === void 0 ? void 0 : _e.setValue(this.findArrivingMinMax(this.response.airItineraries));
                    (_f = this.filterForm.get("arrivingSlider")) === null || _f === void 0 ? void 0 : _f.updateValueAndValidity(); // this.minAnMax(this.response.airItineraries);
                    (_g = this.filterForm.get('priceSlider')) === null || _g === void 0 ? void 0 : _g.setValue(this.minAnMax(this.response.airItineraries));
                    this.stopsvalues(),
                        this.airlinesA = this.response.airlines;
                    this.airlinesForm = [];
                    this.airlinesA.forEach(element => {
                        var _a;
                        (_a = this.filterForm.get('airline')) === null || _a === void 0 ? void 0 : _a.get('airlines').push(new FormControl(false));
                    });
                    this.bookingSitesForm = [];
                    this.bookingSites.forEach(element => {
                        var _a;
                        (_a = this.filterForm.get('bookingSite')) === null || _a === void 0 ? void 0 : _a.get('bookingSites').push(new FormControl(false));
                    });
   ...
   **/
    updateFilter() {
        this.subscription.add(this.filterForm.valueChanges.subscribe((val) => {
            ...
            if (this.formINIT) {
                let filter = new flightResultFilter((_a = this.filterForm.get("sameAirline")) === null || _a === void 0 ? void 0 : _a.value, (_b = this.filterForm.get("priceSlider")) === null || _b === void 0 ? void 0 : _b.value[0], (_d = (_c = this.filterForm) === null || _c === void 0 ? void 0 : _c.get("priceSlider")) === null || _d === void 0 ? void 0 : _d.value[1], (_e = this.filterForm.get("durationSlider")) === null || _e === void 0 ? void 0 : _e.value[0], (_f = this.filterForm.get("durationSlider")) === null || _f === void 0 ? void 0 : _f.value[1], (_g = this.filterForm.get("dpartingSlider")) === null || _g === void 0 ? void 0 : _g.value[0], (_h = this.filterForm.get("dpartingSlider")) === null || _h === void 0 ? void 0 : _h.value[1], (_j = this.filterForm.get("arrivingSlider")) === null || _j === void 0 ? void 0 : _j.value[0], (_k = this.filterForm.get("arrivingSlider")) === null || _k === void 0 ? void 0 : _k.value[1], (_l = this.filterForm.get("returnSlider")) === null || _l === void 0 ? void 0 : _l.value[0], (_m = this.filterForm.get("returnSlider")) === null || _m === void 0 ? void 0 : _m.value[1], this.stopsvalues(), [(_p = (_o = this.filterForm.get('experience')) === null || _o === void 0 ? void 0 : _o.get('overNight')) === null || _p === void 0 ? void 0 : _p.value], [(_r = (_q = this.filterForm.get('flexibleTickets')) === null || _q === void 0 ? void 0 : _q.get('refund')) === null || _r === void 0 ? void 0 : _r.value, (_t = (_s = this.filterForm.get('flexibleTickets')) === null || _s === void 0 ? void 0 : _s.get('nonRefund')) === null || _t === void 0 ? void 0 : _t.value], this.filteringbyairline((_v = (_u = this.filterForm.get('airline')) === null || _u === void 0 ? void 0 : _u.get('airlines')) === null || _v === void 0 ? void 0 : _v.value), this.filteringbyBookingSites((_x = (_w = this.filterForm.get('bookingSite')) === null || _w === void 0 ? void 0 : _w.get('bookingSites')) === null || _x === void 0 ? void 0 : _x.value));
  ...
  **/
    stopsvalues() {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
        let out = [];
        if ((_b = (_a = this.filterForm.get('stopsForm')) === null || _a === void 0 ? void 0 : _a.get('noStops')) === null || _b === void 0 ? void 0 : _b.value) {
            out.push(0);
        }
        if ((_d = (_c = this.filterForm.get('stopsForm')) === null || _c === void 0 ? void 0 : _c.get('oneStop')) === null || _d === void 0 ? void 0 : _d.value) {
            out.push(1);
        }
        if ((_f = (_e = this.filterForm.get('stopsForm')) === null || _e === void 0 ? void 0 : _e.get('twoAndm')) === null || _f === void 0 ? void 0 : _f.value) {
            out.push(2);
            out.push(3);
            out.push(4);
        }
        if (!((_h = (_g = this.filterForm.get('stopsForm')) === null || _g === void 0 ? void 0 : _g.get('noStops')) === null || _h === void 0 ? void 0 : _h.value) && !((_k = (_j = this.filterForm.get('stopsForm')) === null || _j === void 0 ? void 0 : _j.get('oneStop')) === null || _k === void 0 ? void 0 : _k.value) && !((_m = (_l = this.filterForm.get('stopsForm')) === null || _l === void 0 ? void 0 : _l.get('twoAndm')) === null || _m === void 0 ? void 0 : _m.value)) {
            out = [0, 1, 2, 3, 4];
        }
        return out;
    }
  ...
  **/
    filterFlightWithNumberofStopsFunction(flight, filter) {
        ...
        else if ((filter === null || filter === void 0 ? void 0 : filter.stops[0]) == 0 && ((_a = filter.stops) === null || _a === void 0 ? void 0 : _a.length) == 1) {
        ...
        else if (filter.stops[0] == 1 && ((_b = filter.stops) === null || _b === void 0 ? void 0 : _b.length) == 1) {
            for (var i = 0; i < flight.allJourney.flights.length; i++) {
                if (flight.allJourney.flights[i].stopsNum != 1) {
                    stopFlage = false;
                }
    ...
    **/
    ...
    filterFlightWithAirlineFunction(flight, filter, roundT) {
        var _a, _b;
        if (roundT) {
            return filter.airlines.indexOf(flight.allJourney.flights[0]['flightAirline']['airlineName']) != -1 || filter.airlines.indexOf(flight.allJourney.flights[1]['flightAirline']['airlineName']) != -1 || ((_a = filter.airlines) === null || _a === void 0 ? void 0 : _a.length) == 0;
        }
        else {
            return filter.airlines.indexOf(flight.allJourney.flights[0]['flightAirline']['airlineName']) != -1 || ((_b = filter.airlines) === null || _b === void 0 ? void 0 : _b.length) == 0;
        }
    }
    /**
    ...
    **/
    filterWithExperience(flight, filter) {
        if (filter.experience[0] && !filter.experience[1]) {
            ...
            if ((flight === null || flight === void 0 ? void 0 : flight.stopsTime) < 4) {
                return true;
            }
            else {
                return false;
...
class FlightSearchService {
    ...
    multiData(localForm) {
        ...
        for (let i = 0; i < ((_a = localForm.Flights) === null || _a === void 0 ? void 0 : _a.length); i++) {
            this.searchFlight.get('Flights').push(new FormGroup({
    ...
    get flightsArray() {
        var _a;
        return (_a = this.searchFlight) === null || _a === void 0 ? void 0 : _a.get('Flights');
    }
    /**
    ...
    changeAdultPassenger(num) {
        ...
        let Total = this.getTotalPassengers(num, (_b = (_a = this.searchFlight) === null || _a === void 0 ? void 0 : _a.get('passengers.child')) === null || _b === void 0 ? void 0 : _b.value, (_d = (_c = this.searchFlight) === null || _c === void 0 ? void 0 : _c.get('passengers.infant')) === null || _d === void 0 ? void 0 : _d.value);
        if (num <= 9 && num != 0 && Total <= 9) {
            (_f = (_e = this.searchFlight) === null || _e === void 0 ? void 0 : _e.get('passengers.adults')) === null || _f === void 0 ? void 0 : _f.setValue(num);
            this.passengerAlert.arMsg = '';
            this.passengerAlert.enMsg = '';
    ...
    changeChildPassenger(num) {
        ...
        let Total = this.getTotalPassengers((_b = (_a = this.searchFlight) === null || _a === void 0 ? void 0 : _a.get('passengers.adults')) === null || _b === void 0 ? void 0 : _b.value, num, (_d = (_c = this.searchFlight) === null || _c === void 0 ? void 0 : _c.get('passengers.infant')) === null || _d === void 0 ? void 0 : _d.value);
        if (num <= 9 && Total <= 9) {
            (_f = (_e = this.searchFlight) === null || _e === void 0 ? void 0 : _e.get('passengers.child')) === null || _f === void 0 ? void 0 : _f.setValue(num);
            this.passengerAlert.arMsg = '';
            this.passengerAlert.enMsg = '';
            return this.passengerAlert;
        }
    ...
    changeinfantPassenger(num) {
        ...
        this.passengerAlert.arMsg = '';
        this.passengerAlert.enMsg = '';
        let adultVal = (_b = (_a = this.searchFlight) === null || _a === void 0 ? void 0 : _a.get('passengers.adults')) === null || _b === void 0 ? void 0 : _b.value;
        //get total number of passenger with new selected infant value
        let Total = this.getTotalPassengers(adultVal, (_d = (_c = this.searchFlight) === null || _c === void 0 ? void 0 : _c.get('passengers.child')) === null || _d === void 0 ? void 0 : _d.value, num);
        if (num <= adultVal && Total <= 9) {
            (_f = (_e = this.searchFlight) === null || _e === void 0 ? void 0 : _e.get('passengers.infant')) === null || _f === void 0 ? void 0 : _f.setValue(num);
            this.passengerAlert.arMsg = '';
            this.passengerAlert.enMsg = '';
            return this.passengerAlert;
        }
    ...
    switchDestination(item) {
        var _a, _b, _c, _d;
        let destination1 = (_a = item.get("landing")) === null || _a === void 0 ? void 0 : _a.value;
        let destination2 = (_b = item.get("departing")) === null || _b === void 0 ? void 0 : _b.value;
        (_c = item.get("departing")) === null || _c === void 0 ? void 0 : _c.setValue(destination1);
        (_d = item.get("landing")) === null || _d === void 0 ? void 0 : _d.setValue(destination2);
   ...
   */
        ...
        if (this.flightsArray.length > 1) {
            for (let i = 0; i < this.flightsArray.length; i++) {
                ...
                if (i == this.flightsArray.length - 1) {
                    if (((_b = (_a = this.flightsArray.at(i)) === null || _a === void 0 ? void 0 : _a.get('departingD')) === null || _b === void 0 ? void 0 : _b.value) < ((_c = this.flightsArray.at(i - 1).get('departingD')) === null || _c === void 0 ? void 0 : _c.value)) {
                    ...
                    let nextDate = new Date((_e = (_d = this.flightsArray.at(i + 1)) === null || _d === void 0 ? void 0 : _d.get('departingD')) === null || _e === void 0 ? void 0 : _e.value);
                    let currentDate = (_f = this.flightsArray.at(i).get('departingD')) === null || _f === void 0 ? void 0 : _f.value;
                    ...
                    if (nextDate == undefined || nextDate == null) {
                        ...
                        if (nextDate.getTime() < currentDate.getTime()) {
                            this.validMultiDateAlert.enMsg = 'The First Flight should Have A date Before next Flight';
                            this.validMultiDateAlert.arMsg = 'يجب أن يكون للرحلة الأولى تاريخ قبل الرحلة التالية';
                            (_h = (_g = this.flightsArray.at(i + 1)) === null || _g === void 0 ? void 0 : _g.get('departingD')) === null || _h === void 0 ? void 0 : _h.setValue('');
                        }
                        else {
    ...
    setDepDate(depDate, flightIndex) {
        ...
        if (date < this.todayDate()) {
            (_b = (_a = this.searchFlight) === null || _a === void 0 ? void 0 : _a.get('Flights').at(flightIndex).get('departingD')) === null || _b === void 0 ? void 0 : _b.setValue(this.todayDate());
            ...
            if (this.searchFlight.controls['returnDate'].value == date) {
                ...
                (_d = (_c = this.searchFlight) === null || _c === void 0 ? void 0 : _c.get('Flights').at(flightIndex).get('departingD')) === null || _d === void 0 ? void 0 : _d.setValue(this.todayDate());
            }
            else {
                (_f = (_e = this.searchFlight) === null || _e === void 0 ? void 0 : _e.get('Flights').at(flightIndex).get('departingD')) === null || _f === void 0 ? void 0 : _f.setValue(depDate);
            }
        }
    ...
    setRetDate(retDate) {
        ...
        if (retDate) {
            let depDate = (_c = (_b = (_a = this.searchFlight) === null || _a === void 0 ? void 0 : _a.get('Flights').at(0)) === null || _b === void 0 ? void 0 : _b.get('departingD')) === null || _c === void 0 ? void 0 : _c.value;
    ...
    setRetFlight() {
        ...
        if (this.flightsArray.length == 1)
            this.searchFlight.get('Flights').push(new FormGroup({
                departing: new FormControl((_a = this.flightsArray.at(0).get('landing')) === null || _a === void 0 ? void 0 : _a.value, [
                    Validators.required,
                ]),
                landing: new FormControl((_b = this.flightsArray.at(0).get('departing')) === null || _b === void 0 ? void 0 : _b.value, [
                    Validators.required,
                ]),
                departingD: new FormControl((_c = this.searchFlight.get('returnDate')) === null || _c === void 0 ? void 0 : _c.value),
            }));
    }
    /**
    ...
    getFlightInfo(spiltIndex, splitPattern) {
        ...
        if (((_a = this.searchFlight.get('flightType')) === null || _a === void 0 ? void 0 : _a.value) == 'RoundTrip') {
    ...
    getSearchresultLink(lang, currency, pointOfSale, spiltIndex, splitPattern) {
        ...
        let searchApi = {
            ...
            flightType: (_a = this.searchFlight.get('flightType')) === null || _a === void 0 ? void 0 : _a.value,
            flightsInfo: this.flightInfoFormatter(flightList),
            passengers: this.passengerFormatter((_b = this.searchFlight.get('passengers')) === null || _b === void 0 ? void 0 : _b.value),
            Cclass: (_c = this.searchFlight.get('class')) === null || _c === void 0 ? void 0 : _c.value,
            serachId: this.id(),
            showDirect: (_d = this.searchFlight.get('Direct')) === null || _d === void 0 ? void 0 : _d.value,
    ...
    onSubmit(lang, currency, pointOfSale, spiltIndex, splitPattern) {
        ...
        if (!this.searchFlight.value) {
            ...
            let adult = this.changeAdultPassenger((_b = (_a = this.searchFlight) === null || _a === void 0 ? void 0 : _a.get('passengers.adult')) === null || _b === void 0 ? void 0 : _b.value);
            let child = this.changeChildPassenger((_d = (_c = this.searchFlight) === null || _c === void 0 ? void 0 : _c.get('passengers.child')) === null || _d === void 0 ? void 0 : _d.value);
            let infant = this.changeinfantPassenger((_f = (_e = this.searchFlight) === null || _e === void 0 ? void 0 : _e.get('passengers.infant')) === null || _f === void 0 ? void 0 : _f.value);
            var retDate = { arMsg: '', enMsg: '' };
            let depDate = this.setDepDate((_j = (_h = (_g = this.searchFlight) === null || _g === void 0 ? void 0 : _g.get('Flights').at(0)) === null || _h === void 0 ? void 0 : _h.get('departingD')) === null || _j === void 0 ? void 0 : _j.value, 0);
            if (((_k = this.searchFlight.controls['flightType']) === null || _k === void 0 ? void 0 : _k.value) == 'roundtrip' || ((_l = this.searchFlight.controls['flightType']) === null || _l === void 0 ? void 0 : _l.value) == 'RoundTrip' || ((_m = this.searchFlight.controls['flightType']) === null || _m === void 0 ? void 0 : _m.value) == 'roundTrip') {
                //set return date value
                retDate = this.setRetDate(this.searchFlight.controls['returnDate'].value);
                //change between depart and land cities and pushing it to flights array
                this.setRetFlight();
            }
            else if (((_o = this.searchFlight.controls['flightType']) === null || _o === void 0 ? void 0 : _o.value) == 'oneway' || ((_p = this.searchFlight.controls['flightType']) === null || _p === void 0 ? void 0 : _p.value) == 'OneWay' || ((_q = this.searchFlight.controls['flightType']) === null || _q === void 0 ? void 0 : _q.value) == 'oneWay') {
                if (this.flightsArray.length > 1) {
                    this.removeFlight();
                }
            }
            //If All Validations and conditions are true then save the form at local storage and go to search Results
            if (!adult.enMsg && !child.enMsg && !infant.enMsg && !depDate.enMsg && !(retDate === null || retDate === void 0 ? void 0 : retDate.enMsg)) {
